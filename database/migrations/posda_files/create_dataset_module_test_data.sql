...
SELECT setval('recordset_license_license_id_seq', (SELECT MAX(license_id) FROM recordset_license) + 1);

INSERT INTO "public".transfer_destination ( destination_id, name, abbr ) VALUES ( 1, 'Imaging Data Commons', 'idc' );
INSERT INTO "public".transfer_destination ( destination_id, name, abbr ) VALUES ( 2, 'General Commons', 'gc' );
INSERT INTO "public".transfer_destination ( destination_id, name, abbr ) VALUES ( 3, 'WordPress', 'wp' );
INSERT INTO "public".transfer_destination ( destination_id, name, abbr ) VALUES ( 4, 'Aspera Faspex', 'asp' );
INSERT INTO "public".transfer_destination ( destination_id, name, abbr ) VALUES ( 5, 'NBIA', 'nbia' );

SELECT setval('transfer_destination_destination_id_seq', (SELECT MAX(destination_id) FROM transfer_destination) + 1);
...
SELECT setval('dataset_dataset_id_seq', (SELECT MAX(dataset_id) FROM dataset) + 1);
...
SELECT setval('recordset_recordset_id_seq', (SELECT MAX(recordset_id) FROM recordset) + 1);
...
SELECT setval('recordset_release_recordset_release_id_seq', (SELECT MAX(recordset_release_id) FROM recordset_release) + 1);
...
SELECT setval('recordset_draft_recordset_draft_id_seq', (SELECT MAX(recordset_draft_id) FROM recordset_draft) + 1);
...
SELECT setval('dataset_release_dataset_release_id_seq', (SELECT MAX(dataset_release_id) FROM dataset_release) + 1);
