...
in the current activity, excluding the file_ids specified
on STDIN.
...
def main(args):
    ...
    try:
        ...
        raise RuntimeError("Error interpreting input! "
                           "Did you supply file_ids or something else?")
    ...
    print(f"Removing {len(input_lines)} files...")
    old_tp_files = old_tp_files - input_lines

    print(f"Adding {len(old_tp_files)} files to new timepoint...")
