...
my $usage = <<EOF;
BackgroundPrivateDispositionsTpDual.pl <?bkgrnd_id?> <activity_id> <notify> <skip_dispositions> <upd_nbia> <dir>
...
If a baseline date exists, the dates will be offset with that
otherwise the date shift will be used
