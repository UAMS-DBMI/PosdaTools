...
my $usage = <<EOF;
Usage:
BackgroundFixStructLinkagesTp.pl <?bkgrnd_id?> <activity_id> "<comment>" <notify>
or
BackgroundFixStructLinkagesTp.pl -h
...
$background->WriteToEmail("Starting relink on $num_edits RTSTRUCTs\n" .
  "Comment: $comment\n" .
  "Results dir: $DestDir\n" .
