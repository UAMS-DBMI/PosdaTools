...
def parse_args():
    ...
    parser.add_argument(
        'package_dir',
        help='the name of the Faspex package directory'
    )
...
def main(args):
    ...
    background.set_activity_status(f"Copying {human_size} in {file_count} files, est {hr_estimate}")
    ...
    if found_count == file_count:
        ...
        print(f"Found {found_count} files, which doesn't match the earlier count. Something may be wrong")
