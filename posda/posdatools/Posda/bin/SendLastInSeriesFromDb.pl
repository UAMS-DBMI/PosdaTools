...
my $help = <<EOF;
Usage: 
  DicomSendLastInSeriesFromDb.pl <host> <port> <called> <calling> <series> <num_simul>
or
  DicomSendLastInSeriesFromDb.pl -h
EOF
...
my $q_inst = PosdaDB::Queries->GetQueryInstance("LastFilesInSeries");
