-- Name: PotentialDuplicateSopSeriesByCollectionSite
-- Schema: posda_files
-- Columns: ['collection', 'site', 'subj_id', 'study_instance_uid', 'series_instance_uid', 'count']
...
select distinct collection, site, subj_id, study_instance_uid, series_instance_uid, 
