-- Name: DifferentDupSopsReceivedBetweenDatesByCollection
-- Schema: posda_files
-- Columns: ['project_name', 'site_name', 'patient_id', 'study_instance_uid', 'series_instance_uid', 'num_sops', 'num_files', 'num_uploads', 'first_loaded', 'last_loaded']
-- Args: ['start_time', 'end_time', 'collection']
-- Tags: ['receive_reports']
-- Description: Series received between dates with duplicate sops
-- 
