-- Name: NiftiVRlogs
-- Schema: posda_files
-- Columns: ['nifti_visual_review_instance_id', 'nifti_file_id', 'review_status', 'reviewing_user', 'review_time']
-- Args: ['activity_id']
...
select
  nifti_visual_review_instance_id, nifti_file_id, review_status, reviewing_user, review_time
