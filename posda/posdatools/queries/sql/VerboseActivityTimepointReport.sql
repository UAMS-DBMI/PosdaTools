...
-- Schema: posda_files
-- Columns: ['collection', 'site', 'patient_id', 'patient_age', 'study_instance_uid', 'study_date', 'study_description', 'series_instance_uid', 'series_date', 'dicom_file_type', 'modality', 'num_files', 'num_desc']
