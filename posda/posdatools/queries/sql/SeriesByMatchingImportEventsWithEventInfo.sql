-- Name: SeriesByMatchingImportEventsWithEventInfo
-- Schema: posda_files
-- Columns: ['import_event_id', 'import_type', 'import_comment', 'import_time', 'series_instance_uid']
...
select
distinct import_event_id, import_type, import_comment, import_time, series_instance_uid from
