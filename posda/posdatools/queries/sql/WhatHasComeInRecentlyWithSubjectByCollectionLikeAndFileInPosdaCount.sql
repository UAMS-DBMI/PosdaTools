-- Name: WhatHasComeInRecentlyWithSubjectByCollectionLikeAndFileInPosdaCount
-- Schema: posda_backlog
-- Columns: ['collection', 'site', 'subj', 'time', 'number_of_files', 'num_files_in_posda', 'max_delay', 'min_delay']
