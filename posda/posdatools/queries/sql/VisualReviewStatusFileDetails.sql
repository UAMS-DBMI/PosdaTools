-- Name: VisualReviewStatusFileDetails
-- Schema: posda_files
-- Columns: ['image_equivalence_class_id', 'series_instance_uid', 'processing_status', 'review_status', 'visibility', 'file_id']
...
select 
  ...
  processing_status, review_status, visibility, file_id
