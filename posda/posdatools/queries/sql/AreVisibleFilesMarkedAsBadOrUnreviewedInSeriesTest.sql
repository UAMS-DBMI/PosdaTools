-- Name: AreVisibleFilesMarkedAsBadOrUnreviewedInSeriesTest
-- Schema: posda_files
-- Columns: ['collection', 'site', 'patient_id', 'series_instance_uid', 'dicom_file_type', 'modality', 'review_status', 'processing_status', 'visibility', 'num_files']
