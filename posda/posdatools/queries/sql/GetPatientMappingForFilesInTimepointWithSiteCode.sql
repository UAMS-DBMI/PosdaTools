...
-- Schema: posda_files
-- Columns: ['from_patient_id', 'to_patient_id', 'to_patient_name', 'collection_name', 'site_name', 'site_code', 'uid_root', 'diagnosis_date', 'baseline_date', 'date_shift', 'computed_shift','upload_id']
