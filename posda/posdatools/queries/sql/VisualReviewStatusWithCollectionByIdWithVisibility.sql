-- Name: VisualReviewStatusWithCollectionByIdWithVisibility
-- Schema: posda_files
-- Columns: ['collection', 'site', 'series_instance_uid', 'review_status', 'visibility', 'modality', 'series_description', 'series_date', 'num_equiv_classes', 'num_files']
...
group by collection, site, series_instance_uid, visibility, review_status, modality, series_description, series_date;