...
-- Schema: posda_files
-- Columns: ['from_patient_id', 'to_patient_id', 'to_patient_name', 'collection_name', 'site_name', 'batch_number', 'diagnosis_date', 'baseline_date', 'date_shift', 'uid_root', 'computed_shift','upload_id']
-- Args: ['file_id']
...
select
  ...
  baseline_date - diagnosis_date + interval '1 day' as computed_shift, upload_id
from
