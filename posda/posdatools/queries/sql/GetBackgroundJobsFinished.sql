...
-- Schema: posda_files
-- Columns: ['subprocess_invocation_id', 'work_id', 'background_subprocess_id', 'activity_id', 'status', 'input_file_id', 'stdout_file_id', 'invoking_user', 'stderr_file_id', 'command_line', 'since_invocation', 'when_invoked', 'user_to_notify']
-- Args: []
