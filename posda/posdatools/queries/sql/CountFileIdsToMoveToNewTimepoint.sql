-- Name: CountFileIdsToMoveToNewTimepoint
-- Schema: posda_files
-- Columns: ['num_files']
-- Args: ['activity_id', 'visual_review_instance_id']
-- Tags: ['visual_review']
-- Description:  The cardinality of the set of files which need to remain in the timepoint, after removing the files which are marked Bad in the VR
--

select count(*) as num_files from (
with tp_id as (
