...
from papi.routes import distribution
from papi.routes import manager
...
router_v1.include_router(distribution.router, prefix="/distribution")
router_v1.include_router(manager.router, prefix="/manager")
