#!/usr/bin/perl -w
#$Source: /home/bbennett/pass/archive/TciaCuration/bin/GetNLSTFilesBySeriesInstanceUid.pl,v $
#$Date: 2015/10/01 13:10:31 $
#$Revision: 1.1 $
#
use strict;
use DBI;
...
for my $i (@images){
  ...
  my $db_root = "/usr/local/apps/ncia/CTP-server/CTP/storage";
  my $fs_root = "/mnt/erlbluearc/systems/public-lss/data/storage";
