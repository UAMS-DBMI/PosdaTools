#!/usr/bin/perl -w
#$Source: /home/bbennett/pass/archive/TciaCuration/include/TciaCuration/CompareRevisions.pm,v $
#$Date: 2015/06/10 21:07:05 $
#$Revision: 1.2 $
#
use strict;
use POSIX 'strftime';
...
use Debug;
my $dbg = sub { print @_ };
package TciaCuration::CompareRevisions;
use Fcntl;
use vars qw( @ISA );
@ISA = ("Posda::HttpApp::JsController", "TciaCuration::InfoExpander");
my $expander = <<EOF;
<?dyn="BaseHeader"?>
...
sub new{
  ...
  $this->{title} = "Tcia Curation Tools: Compare Revisions";
