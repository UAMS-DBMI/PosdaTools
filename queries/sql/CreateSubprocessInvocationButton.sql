...
-- Columns: []
-- Args: ['query_invoked_by_dbif_id', 'btn_name', 'command_line', 'invoking_user']
...
insert into subprocess_invocation(
 from_spreadsheet, from_button, query_invoked_by_dbif_id,
 button_name, command_line, invoking_user, when_invoked
) values (
  false, true, ?, ?, ?, ?, now()
)