...
-- 
-- NB: project_name will be null if there is no ctp_file row (so to hide the file you need to create a row with project_name = 'UNKNOWN', site_name = 'UNKNOWN' and visibility = 'hidden' (if you want to hide the file)
