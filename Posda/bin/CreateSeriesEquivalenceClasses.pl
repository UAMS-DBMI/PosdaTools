...
die "This script is obsolete. Please use NewCreateSeriesEquivalenceClasses instead."
#New file does the same thing but adds the visual review instance id field.
