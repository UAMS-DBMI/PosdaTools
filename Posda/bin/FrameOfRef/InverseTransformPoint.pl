#!/usr/bin/perl -w 
#$Source: /home/bbennett/pass/archive/Posda/bin/FrameOfRef/InverseTransformPoint.pl,v $
...
for my $m (@$match){
  ...
  my $xform = Posda::Transforms::InvertTransform(
    Posda::Transforms::MakeFromDicomXform(
      $ds->Get(
  ...
  printf "InverseTransform[%d]: [%0.6f, %0.6f, %0.6f] => [%0.6f, %0.6f, %0.6f]\n",
