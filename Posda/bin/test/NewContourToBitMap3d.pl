#!/usr/bin/perl -w
#$Source: /home/bbennett/pass/archive/Posda/bin/test/NewContourToBitMap3d.pl,v $
#$Date: 2011/11/04 16:01:56 $
#$Revision: 1.2 $
#
...
#  $child_args->{debug} = 1;
  my $child_pid = PipeChildren::Spawn("NewContourToBitMap.pl", 
