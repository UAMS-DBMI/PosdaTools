...
# setup various queries for first-stage
...
# TODO combine this with the previous query, which now returns the id
...
my $q4 = PosdaDB::Queries->GetQueryInstance("CreateBackgroundInputLine");
...
my $grandchild_pid = $$;
print STDERR "#### grandchild_pid: $grandchild_pid\n";
...
print STDERR "#### Finished updating the tables, about to start email\n";
...
$add_time_rows_to_bkgrnd->RunQuery(sub {}, sub{},
  $num_sops, $grandchild_pid, $bkgrnd_id
);
