#!/usr/bin/perl -w
#$Source: /home/bbennett/pass/archive/Posda/bin/contrib/BulkInsertPosdaElements.pl,v $
...
my $usage = sub {
	print "usage: $0 <source> <destination> [<ele> ...]";
	exit -1;
}
unless(
	$#ARGV == 1
...
#    if($ds->Get($i)){
print "inserting $Substitutions{$i} into $i\n";
